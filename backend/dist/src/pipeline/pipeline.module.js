...
exports.PipelineModule = PipelineModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [pipeline_service_1.PipelineService, prisma_service_1.PrismaService, pipeline_repository_1.PipelineRepository],
        exports: [pipeline_repository_1.PipelineRepository],
    })
], PipelineModule);
